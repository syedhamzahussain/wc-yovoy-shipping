			...
			$settings = array(
				...
				'section_google_address' => array(
					...
					'custom_attributes' => array_merge(
						array(
							'data-lat'  => get_option( 'wcys_pickup_latitude' ) ? get_option( 'wcys_pickup_latitude' ) : 15.199999,
							'data-long' => get_option( 'wcys_pickup_longitude' ) ? get_option( 'wcys_pickup_longitude' ) : -86.241905,
						),
						$readonly
					),
				),
